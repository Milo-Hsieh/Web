...
const seeMoreButtons = document.querySelectorAll("[class^='seeMoreButton']");

seeMoreButtons.forEach((button) => {
  button.addEventListener("click", () => {
    const buttonClass = button.className;
    const buttonNumber = buttonClass.replace("seeMoreButton", "");
    window.location.href = `./portfolio.html#${buttonNumber}`;
  });
});
